...
public class SmhServiceRequest implements Cloneable, Serializable {
    ...
    /**
     * The mannually set shm server ip and port, format is ip:port
     */
     ...
     */
    private SmhServiceRequest cloneSource;
    ...
    /**
     * Sets the smh server ip and port .
     *
     ...
     */
    public <T extends SmhServiceRequest> T withGeneralProgressListener(ProgressListener progressListener) {
     ...
     */
    protected final <T extends SmhServiceRequest> T copyBaseTo(T target) {
        if (customRequestHeaders != null) {
     ...
     * one.
     */
    public SmhServiceRequest getCloneSource() {
        return cloneSource;
    }
     ...
     */
    public SmhServiceRequest getCloneRoot() {
        SmhServiceRequest cloneRoot = cloneSource;
        if (cloneRoot != null) {
    ...
    private void setCloneSource(SmhServiceRequest cloneSource) {
        this.cloneSource = cloneSource;
    }
    
    /**
     * Creates a shallow clone of this object for all fields except the handler context.
     * Explicitly does <em>not</em> clone the
     * deep structure of the other fields in the message.
     *
     * @see Object#clone()
     */
    @Override
    public SmhServiceRequest clone() {
        try {
            SmhServiceRequest cloned = (SmhServiceRequest) super.clone();
