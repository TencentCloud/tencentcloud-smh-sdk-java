...
public enum ProgressEventType {
    //////////////////////////////////////////////////////////////////////////
    // Request Cycle Event:
    // related to the execution of a single http request-response to SMH
    //////////////////////////////////////////////////////////////////////////
    /**
    ...
    /**
     * Used to indicate the number of bytes to be sent to SMH.
     */
    REQUEST_BYTE_TRANSFER_EVENT,
    /**
     * Used to indicate the number of bytes received from SMH.
     */
    RESPONSE_BYTE_TRANSFER_EVENT,
    /**
     * Used to indicate the number of bytes discarded after being received from SMH.
     */
    ...
    /**
     * Event indicating that the client has started sending the SMH API request.
    ...
    //////////////////////////////////////////////////////////////////////////
    // Transfer Event:
    // Progress events that are used by SMH client */
    //////////////////////////////////////////////////////////////////////////
     ...
     * single http request-response to SMH; false otherwise.
     */
